//
// Created by Chris Kendall on 11/20/22.
//
#include <iostream>
#include <sstream>
#include <vector>
...
int Test(){
    ...
    shapes.push_back(new Triangle(1, 5, 4, output));
    Test(output.str() == "Shape Constructor\nTriangle Constructor\n", "Triangle Constructor", passedTests);
    output.str("");

    shapes.push_back(new EquilateralTriangle(5, output));
    Test(output.str() == "Shape Constructor\nTriangle Constructor\nEquilateralTriangle Constructor\n", "EquilateralTriangle Constructor", passedTests);
    output.str("");
    ...
    Test(CountTriangles(shapes) == 2, "Count Triangles", passedTests);
    Test(CountEquilateralTriangles(shapes) == 1, "Count EquilateralTriangles", passedTests);
    Test(CountSpecificTriangles(shapes) == 1, "Count Specific Triangles", passedTests);

    // Done Testing Triangles
    ...
    // Deallocating Triangles

    delete shapes.at(10);
    Test(output.str() == "Triangle Destructor\nShape Destructor\n", "Triangle Destructor", passedTests);
    output.str("");

    delete shapes.at(11);
    Test(output.str() == "EquilateralTriangle Destructor\nTriangle Destructor\nShape Destructor\n", "EquilateralTriangle Destructor", passedTests);
    output.str("");

    // Done Deallocating Triangles
...
/**
 * Prints the test results to cout whether test condition is met or failed.
 * @param condition bool
 * @param message char*
 * @param passedTests unsigned int
 */
void Test(bool condition, const char* message, unsigned int& passedTests){
    if (condition){
